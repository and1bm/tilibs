...
// ticalcs_calc_send_var_: core of ticalcs_calc_send_var, the take_busy argument enables avoiding playing games with handle->busy in rd_send().
...
// ticalcs_calc_send_var2_: core of ticalcs_calc_send_var2, the take_busy argument enables avoiding playing games with handle->busy in rd_send().
